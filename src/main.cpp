...
unsigned int createProgram( const std::string &vertex_shaderSource , const std::string &fragment_shaderSource );
...
#pragma endregion
	...
	std::string fragment_shader_source = parseShader( "../res/shaders/shader.frag" );
	unsigned int shaderProgram = createProgram( vertex_shader_source , fragment_shader_source );
...
#pragma region BufferAndPass
	...
	glVertexAttribPointer( 1 , 4 , GL_FLOAT , GL_FALSE , sizeof( float ) , (void *) ( 12 * sizeof( float ) ) );
